  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="grid gap-8 sm:grid-cols-2 md:gap-12 xl:grid-cols-3 xl:gap-16">
      ...
      <div className="flex gap-4 md:gap-6">
        ...
        <div>
          <h3 className="mb-2 text-lg font-semibold md:text-xl">Productivity</h3>
          <p className="mb-2 text-gray-500">Filler text is dummy text which has no meaning however looks very similar to real text.</p>
          <a href="#" className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
        </div>
      </div>
      ...
      <div className="flex gap-4 md:gap-6">
        ...
        <div>
          <h3 className="mb-2 text-lg font-semibold md:text-xl">Improvement</h3>
          <p className="mb-2 text-gray-500">Filler text is dummy text which has no meaning however looks very similar to real text.</p>
          <a href="#" className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
        </div>
      </div>
      ...
      <div className="flex gap-4 md:gap-6">
        ...
        <div>
          <h3 className="mb-2 text-lg font-semibold md:text-xl">Fast Learning</h3>
          <p className="mb-2 text-gray-500">Filler text is dummy text which has no meaning however looks very similar to real text.</p>
          <a href="#" className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
        </div>
      </div>
      ...
      <div className="flex gap-4 md:gap-6">
        ...
        <div>
          <h3 className="mb-2 text-lg font-semibold md:text-xl">24/7 Support</h3>
          <p className="mb-2 text-gray-500">Filler text is dummy text which has no meaning however looks very similar to real text.</p>
          <a href="#" className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
        </div>
      </div>
      ...
      <div className="flex gap-4 md:gap-6">
        ...
        <div>
          <h3 className="mb-2 text-lg font-semibold md:text-xl">Skill Improvement</h3>
          <p className="mb-2 text-gray-500">Filler text is dummy text which has no meaning however looks very similar to real text.</p>
          <a href="#" className="font-bold text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700">More</a>
        </div>
      </div>
...
<div className="bg-white py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-lg px-4 md:px-8">
    ...
    <div className="mb-8 md:mb-12">
      <h2 className="mb-4 text-center text-2xl font-bold text-gray-800 md:mb-6 lg:text-3xl">Our Learners</h2>

      <p className="mx-auto max-w-[90%] text-center text-gray-500 md:text-lg">Book-reading is the activity of reading written or printed books, whether they are physical or digital. It can be a solitary activity or shared with others, and can be done for pleasure, education, or research. Reading books can help to improve vocabulary, comprehension, and critical thinking skills, as well as providing a source of entertainment and relaxation.</p>
    </div>
    {/* <!-- text - end --> */}
    ...
    <div className="grid grid-cols-2 gap-6 rounded-lg bg-indigo-500 p-6 md:grid-cols-4 md:gap-8 md:p-8">
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-sm text-indigo-200 sm:text-base">Officers</div>
      </div>
      {/* <!-- stat - end --> */}
      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-sm text-indigo-200 sm:text-base">Teacher</div>
      </div>

      {/* <!-- stat - start --> */}
      <div className="flex flex-col items-center">
        <div className="text-xl font-bold text-white sm:text-2xl md:text-3xl">1000+</div>
        <div className="text-sm text-indigo-200 sm:text-base">Students</div>
      </div>
      {/* <!-- stat - end --> */}
      ...
      <div className="flex flex-col items-center">
        <div className="text-xl font-bold text-white sm:text-2xl md:text-3xl">1000+</div>
        <div className="text-sm text-indigo-200 sm:text-base">Other Industries</div>
      </div>
      {/* <!-- stat - end --> */}
    </div>
  </div>
...
<div className="bg-white py-6 sm:py-8 lg:py-12">
  <div className="mx-auto max-w-screen-xl px-4 md:px-8">
    ...
    <div className="mb-10 md:mb-16">
      ...
      <p className="mx-auto max-w-[90%] text-center text-gray-500 md:text-lg">Our team is made up of individuals with different backgrounds, experiences, and expertise. Each team member brings their unique perspective and skillset to the group, which can lead to better problem-solving, collaboration, and innovation. Effective teams are built on mutual respect, trust, and open communication, where each member feels valued and heard. By working together towards a common goal, team members can achieve much more than they would on their own. It's important for teams to celebrate their successes and learn from their failures, as this helps to foster a culture of continuous improvement and growth.</p>
    </div>
    {/* <!-- text - end --> */}
