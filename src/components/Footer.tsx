...
export default function Footer() {
    return (
        <footer>
            <div className="bg-white pt-8 md:pt-20">
                <div className="container m-auto space-y-8 px-6 text-gray-600 bg-white md:px-12 lg:px-20">
                    <div>
                        <div
                        ...
                        >
                            ...
                            >
                                <select
                                    name="langage"
                                    id="langae"
                                    className="w-full rounded-xl bg-yellow-100 px-4 py-2 sm:w-max"
                                >
                        ...
                        <div>
                            <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:grid-cols-5">
                                <div>
                                    <h6 className="text-lg font-medium text-gray-900">Categories</h6>
                                ...
                                <div>
                                    <h6 className="text-lg font-medium text-gray-900">Products</h6>
                                    <ul className="mt-4 list-inside space-y-4">
                                        <li>
                                            <a href="#" className="transition hover:text-primary">About</a>
                                        </li>
                                ...
                                <div>
                                    <h6 className="text-lg font-medium text-gray-900">Ressources</h6>
                                    <ul className="mt-4 list-inside space-y-4">
                                        <li>
                                            <a href="#" className="transition hover:text-primary">About</a>
                                        </li>
                                ...
                                <div className="col-span-2 sm:col-span-3 md:col-span-2">
                                    <h6 className="text-lg font-medium text-gray-900">Contact</h6>
                                    <ul className="mt-4 list-inside space-y-4">
                                        <li>
